						...
						<c:if test="${simg.simg_order_no==n}">
							<tr class="numChecking">
								<td colspan="3" class="currentImg">
									...
									<input type="file" name="imgfiles" class="fileUpload modifyFile">
									<input type="button" value="위" class="positionUp" >
									<input type="button" value="아래" class="positionDn">
									<input type="button" value="삭제" class="trDelete deleteFile">
